    ...
    <View style={styles.container}>
      <ScrollView>
        ...
        {equipment.equipment_image ? (
          <Image
            source={{ uri: `http://YOUR_IP:5000/${equipment.equipment_image}` }}
        ...
        <View style={styles.content}>
          {/* Status Badge */}
          <View
            style={[styles.statusBadge, { backgroundColor: getStatusColor(equipment.status) }]}
          >
          ...
          <View style={styles.modalContent}>
            ...
            <ScrollView style={styles.modalBody}>
              ...
              {showStartTimePicker && (
                <DateTimePicker
                  ...
                  onChange={(event, time) => {
                    ...
                    if (time) setBookingData({ ...bookingData, startTime: time });
                  }}
                />
              )}
              ...
              <TextInput
                ...
                onChangeText={(text) => setBookingData({ ...bookingData, purpose: text })}
                multiline
                numberOfLines={4}
              />
            </ScrollView>
