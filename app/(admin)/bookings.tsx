...
export default function AdminBookingsScreen() {
  ...
  const loadBookings = async () => {
    try {
      const response = await bookingAPI.getAll({ status: filterStatus === 'all' ? undefined : filterStatus });
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
              ...
              {selectedBooking && (
                <>
                  ...
                  <View style={styles.bookingDetails}>
                    ...
                    <Text style={styles.detailValue}>{selectedBooking.equipment_name}</Text>
                  </View>

                  <View style={styles.bookingDetails}>
                    <Text style={styles.detailLabel}>Date & Time:</Text>
                    <Text style={styles.detailValue}>
                      {format(new Date(selectedBooking.booking_date), 'MMM dd, yyyy')} | {selectedBooking.start_time} - {selectedBooking.end_time}
                    </Text>
                  </View>
            ...
            <View style={styles.modalFooter}>
              <TouchableOpacity
                style={[styles.modalButton, styles.modalRejectButton, isProcessing && styles.buttonDisabled]}
              ...
              <TouchableOpacity
                style={[styles.modalButton, styles.modalApproveButton, isProcessing && styles.buttonDisabled]}
