...
export default function AdminProfileScreen() {
  ...
  const handleSaveProfile = async () => {
    ...
    try {
      ...
      setUser({ ...user!, name: editData.name, phone: editData.phone, department: editData.department });
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.header}>
        <TouchableOpacity style={styles.imageContainer} onPress={handleImagePick}>
          {user?.profile_image ? (
            <Image
              source={{ uri: `http://YOUR_IP:5000/${user.profile_image}` }}
        ...
        <View style={styles.statsSection}>
          ...
          <View style={styles.statsGrid}>
            <View style={styles.statCard}>
              ...
              <Text style={styles.statValue}>{profile.statistics.activity.total_hours}</Text>
              <Text style={styles.statLabel}>Work Hours</Text>
            </View>
            <View style={styles.statCard}>
              <Ionicons name="calendar-outline" size={32} color="#4caf50" />
              <Text style={styles.statValue}>{profile.statistics.bookings.total_bookings}</Text>
              <Text style={styles.statLabel}>Bookings</Text>
            </View>
            <View style={styles.statCard}>
              <Ionicons name="flask-outline" size={32} color="#ff9800" />
              <Text style={styles.statValue}>{profile.statistics.usage.total_usage_sessions}</Text>
              <Text style={styles.statLabel}>Sessions</Text>
            </View>
            <View style={styles.statCard}>
              <Ionicons name="print-outline" size={32} color="#9c27b0" />
              <Text style={styles.statValue}>{profile.statistics.prints.total_prints}</Text>
